...
class CronCreateTool(Tool[dict[str, Any], dict[str, Any]]):
    ...
    async def call(
        ...
        if input.get("repeat_duration"):
            from kernel.agents.mustang.schedule.schedule_parser import parse_schedule
        ...
        if input.get("repeat_until"):
            from kernel.agents.mustang.schedule.schedule_parser import _parse_iso
        ...
        from kernel.agents.mustang.schedule.schedule_parser import human_schedule
