...
* Fills in :class:`~kernel.core.protocol.interfaces.contracts.connection_context.ConnectionContext`.
...
import kernel
from kernel.core.protocol.acp.namespaces import MUSTANG_EXTENSION_METHODS
...
class AcpHandshake:
    """Concrete :class:`~kernel.core.protocol.interfaces.handshake.Handshake`
    ...
    async def initialize(
        ...
        return InitializeResponse(
            ...
            agent_capabilities=AcpAgentCapabilities(
                ...
                meta={
                    "mustang.agent/extensions": sorted(MUSTANG_EXTENSION_METHODS),
