...
| ACP namespace migration | CLI calls active DeepCLI extensions through `_mustang.agent/*`; legacy parsing for old execution updates was removed. | [../../kernel/interfaces/protocol/history/acp-acpx-schema-alignment-plan.md](../../kernel/interfaces/protocol/history/acp-acpx-schema-alignment-plan.md) |
