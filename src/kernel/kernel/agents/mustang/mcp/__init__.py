...
from kernel.agents.mustang.mcp.types import (
    ConnectedServer,
    DisabledServer,
    FailedServer,
    McpAuthError,
...
class MCPManager(Subsystem):
    ...
    async def startup(self) -> None:
        ...
        # 6. Health monitor.
        from kernel.agents.mustang.mcp.health import health_loop
    ...
    async def call_tool(
        ...
        try:
            ...
            if self._module_table.secrets:
                from kernel.agents.mustang.mcp.oauth import try_refresh_token
