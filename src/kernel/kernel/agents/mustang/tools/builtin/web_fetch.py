...
from kernel.agents.mustang.tools.web.preapproved import PREAPPROVED_HOSTS
...
class WebFetchTool(Tool[dict[str, Any], dict[str, Any]]):
    ...
    async def call(
        ...
        from kernel.core.protocol.interfaces.contracts.content_block import TextBlock
        ...
        yield ToolCallResult(
            data={
                ...
                "raw_length": getattr(result, "raw_length", 0),
                "cached": getattr(result, "cached", False),
                "post_processed": post_processed,
                "browser_signals": (result.metadata or {}).get("browser_signals"),
