...
from kernel.agents.mustang.hooks import HookEvent
from kernel.agents.mustang.llm.types import ToolResultContent, ToolUseContent
from kernel.agents.mustang.orchestrator.events import ToolCallProgress as ToolCallProgressEvent
...
from kernel.agents.mustang.orchestrator.tools_exec.result_mapping import apply_result_budget, coerce_content
from kernel.agents.mustang.orchestrator.tools_exec.shared import FILE_MUTATING_TOOLS, EventPair

if TYPE_CHECKING:
    from collections.abc import Callable

    from kernel.agents.mustang.hooks import HookEventCtx
    from kernel.agents.mustang.orchestrator.events import ToolCallError
    from kernel.agents.mustang.tool_authz import AuthorizeContext, ToolAuthorizer
    from kernel.agents.mustang.tool_authz.types import PermissionDecision
    from kernel.agents.mustang.tools import Tool
...
class ToolPipelineMixin:
    ...
    async def _run_one(
        ...
        *,
        ...
        from kernel.agents.mustang.tool_authz import PermissionAllow
        ...
        try:
            async for event in tool.call(effective_input, tool_ctx):
                from kernel.agents.mustang.tools.types import ToolCallProgress as TP
                from kernel.agents.mustang.tools.types import ToolCallResult as TR
