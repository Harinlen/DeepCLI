...
from kernel.agents.mustang.llm.types import Message, TextContent
from kernel.agents.mustang.orchestrator import OrchestratorConfig, OrchestratorConfigPatch
from kernel.agents.mustang.orchestrator.agents import drain_orphan_notifications, make_spawn_subagent
from kernel.agents.mustang.orchestrator.compactor import Compactor
from kernel.agents.mustang.orchestrator.constants import (
...
from kernel.agents.mustang.orchestrator.hooks import fire_query_hook
from kernel.agents.mustang.orchestrator.history import ConversationHistory
from kernel.agents.mustang.orchestrator.loop import run_query
from kernel.agents.mustang.orchestrator.notifications import (
...
from kernel.agents.mustang.orchestrator.prompt_runtime import (
    build_session_guidance,
    dump_system_prompt as _dump_system_prompt,
    inject_plan_mode_prompts,
    inject_session_guidance,
)
from kernel.agents.mustang.orchestrator.reminders import (
    drain_pending_reminders as _drain_pending_reminders,
)
from kernel.agents.mustang.orchestrator.reminders import extract_text as _extract_text
from kernel.agents.mustang.orchestrator.reminders import format_reminders as _format_reminders
from kernel.agents.mustang.orchestrator.reminders import to_text_content as _to_text_content
from kernel.agents.mustang.orchestrator.runtime import PermissionMode
from kernel.agents.mustang.orchestrator.types import OrchestratorDeps, PermissionCallback, StopReason
...
class StandardOrchestrator:
    ...
    def _plan_file_path(self) -> str:
        ...
        """
        from kernel.agents.mustang.plans import get_plan_file_path
