...
from kernel.agents.mustang.orchestrator.tools_exec.permissions import permission_options_from_suggestions

if TYPE_CHECKING:
    from kernel.agents.mustang.tool_authz import AuthorizeContext, PermissionDecision, ToolAuthorizer
    ...
    async def _authorize(
        ...
        *,
        ...
        if authorizer is None:
            ...
            from kernel.agents.mustang.tool_authz.types import ReasonFailClosed
        ...
        from kernel.agents.mustang.tool_authz import PermissionAsk
        ...
        try:
            ...
            from kernel.agents.mustang.tool_authz import PermissionDeny
            from kernel.agents.mustang.tool_authz.types import ReasonNoPrompt
