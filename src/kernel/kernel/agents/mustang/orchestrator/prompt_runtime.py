...
from kernel.agents.mustang.orchestrator.runtime import PlanPromptRuntime, QueryRuntime, system_reminder_section
...
def inject_plan_mode_prompts(
    ...
    if (orchestrator._plan_mode_attachment_count % FULL_REMINDER_EVERY_N) == 1:
        from kernel.agents.mustang.plans import get_plan
