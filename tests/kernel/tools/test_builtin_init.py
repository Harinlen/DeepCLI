...
def test_bash_tool_on_unix() -> None:
    ...
    with patch("kernel.agents.mustang.tools.builtin.selected_shell_tool", return_value="Bash"):
        from kernel.agents.mustang.tools.builtin import _shell_tool
...
def test_powershell_tool_on_windows() -> None:
    ...
    with patch("kernel.agents.mustang.tools.builtin.selected_shell_tool", return_value="PowerShell"):
        from kernel.agents.mustang.tools.builtin import _shell_tool
...
def test_cmd_tool_on_windows_without_powershell() -> None:
    ...
    with patch("kernel.agents.mustang.tools.builtin.selected_shell_tool", return_value="Cmd"):
        from kernel.agents.mustang.tools.builtin import _shell_tool
