...
from kernel.agents.mustang.orchestrator.constants import SUBAGENT_DEFAULT_MAX_TURNS
from kernel.agents.mustang.orchestrator.events import SubAgentEnd, SubAgentStart, ToolCallStart
from kernel.agents.mustang.orchestrator.runtime import SubAgentParentRuntime
from kernel.agents.mustang.orchestrator.types import PermissionCallback, PermissionResponse, StopReason
...
def drain_orphan_notifications(parent: SubAgentParentRuntime, ended_agent_id: str) -> None:
    ...
    Returns:
        ``None``.
    """
    from kernel.agents.mustang.orchestrator.notifications import format_task_notification
