"""SecretStore schema version 2 migration source markers."""
...
def _create_table(sync_conn: Connection) -> None:
    tables.secret_migration_sources.create(sync_conn, checkfirst=True)


async def migrate(conn: AsyncConnection) -> None:
    """Create secret legacy import marker table."""
