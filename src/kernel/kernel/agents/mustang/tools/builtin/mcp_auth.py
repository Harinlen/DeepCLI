...
from kernel.agents.mustang.tools.mcp_adapter import _normalize
...
class McpAuthTool(Tool[dict[str, Any], dict[str, Any]]):
    ...
    async def call(
        ...
        from kernel.agents.mustang.mcp.oauth_callback import run_callback_server
        ...
        async def _complete_oauth() -> None:
            try:
                ...
                from kernel.agents.mustang.mcp.oauth import exchange_code
