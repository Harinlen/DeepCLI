...
from kernel.agents.mustang.orchestrator.types import StopReason as OrchestratorStopReason
from kernel.agents.mustang.sessions.runtime.config_options import config_descriptor_dicts
...
def make_summarise_closure(llm_manager: Any) -> Callable[[str, str], Awaitable[str]] | None:
    ...
    async def summarise(content: str, _user_prompt: str) -> str:
        from kernel.agents.mustang.llm.types import PromptSection, TextChunk, TextContent, UserMessage
