...
from kernel.core.protocol.acp.schemas.updates import ConfigOptionUpdate, CurrentModeUpdate
...
from kernel.core.protocol.interfaces.contracts.set_config_option_result import SetConfigOptionResult
...
from kernel.agents.mustang.sessions.runtime.config_options import (
    MODE_CONFIG_ID,
...
class SessionHandlerMixin(_SessionMixinBase):
    ...
    async def _maybe_create_worktree_session(
        ...
        try:
            ...
            from kernel.agents.mustang.git.worktree import (
                create_worktree,
                find_git_root,
    ...
    async def list(self, ctx: HandlerContext, params: ListSessionsParams) -> ListSessionsResult:
        ...
        if not params.include_empty and params.cwd is None:
