...
from kernel.agents.mustang.orchestrator.tools_exec.shared import SENTINEL, EventPair
from kernel.agents.mustang.orchestrator.tools_exec.result_mapping import coerce_content
...
if TYPE_CHECKING:
    ...
    from kernel.agents.mustang.tool_authz import AuthorizeContext, PermissionMode, ToolAuthorizer
    from kernel.agents.mustang.tools import Tool, ToolManager
...
class ToolSchedulerMixin:
    ...
    async def _run_nested_tool(
        ...
        *,
        ...
        from kernel.agents.mustang.tools.repl.primitives import REPL_PRIMITIVE_TOOLS
