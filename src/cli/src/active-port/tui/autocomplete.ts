...
import { fuzzyFind } from "@/compat/natives.js";
import { getProjectDir } from "@/compat/utils.js";
...
export class CombinedAutocompleteProvider implements AutocompleteProvider {
	...
	#basePath: string;
	// Intentionally separate from the native helper cache: this cache is a local,
