...
delegated to :func:`kernel.agents.access.security._fs.atomic_write_0600`, which is
...
def generate_token() -> str:
    ...
    (:meth:`kernel.agents.access.security.ConnectionAuthenticator.rotate_token`) needs a new
...
def load_or_create_token(path: Path) -> str:
    ...
    Called from :meth:`kernel.agents.access.security.ConnectionAuthenticator.startup`.  The
