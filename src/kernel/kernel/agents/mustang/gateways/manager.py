...
:class:`~kernel.agents.mustang.gateways.base.GatewayAdapter` subclass per entry, and
...
from kernel.agents.mustang.gateways.base import GatewayAdapter
...
def _build_adapter_registry() -> dict[str, type[GatewayAdapter]]:
    from kernel.agents.mustang.gateways.discord.adapter import DiscordAdapter
