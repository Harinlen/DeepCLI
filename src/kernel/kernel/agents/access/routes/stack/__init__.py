...
:class:`kernel.agents.access.routes.flags.TransportFlags`.
...
validates :class:`kernel.agents.access.routes.flags.TransportFlags.stack` against
...
def create_stack(name: StackName, module_table: KernelModuleTable) -> ProtocolStack[Any]:
    ...
    """
    if name == "acp":
        from kernel.core.protocol import build_protocol_stack
