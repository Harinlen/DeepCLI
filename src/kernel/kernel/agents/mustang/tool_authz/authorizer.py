...
from kernel.agents.mustang.tool_authz.rule_engine import EngineOutcome, RuleEngine
from kernel.agents.mustang.tool_authz.rule_store import RuleStore
from kernel.agents.mustang.tool_authz.runtime_guard import runtime_kill_denial
...
class ToolAuthorizer(Subsystem):
    ...
    async def _fire_permission_hook(
        ...
        *,
        ...
        """
        from kernel.agents.mustang.hooks import AmbientContext, HookEvent, HookEventCtx
...
def _is_plan_file_write(tool: Tool, tool_input: dict[str, Any], ctx: Any) -> bool:
    ...
    """
    from kernel.agents.mustang.plans import is_session_plan_file
